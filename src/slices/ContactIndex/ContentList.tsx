...
type ContentListProps = {
  ...
  contentType: Content.ContactIndexSlice["primary"]["content_type"];
  fallbackItemImage: Content.ContactIndexSlice["primary"]["fallback_item_image"];
  viewMoreText: Content.ContactIndexSlice["primary"]["view_more_text"];
};
